...
namespace GrafikaZadania
{
    class Math3D
    {
        ...
        public class Cube
        {
            ...
            PathGradientBrush frontBrush;
            PathGradientBrush rightBrush;
            PathGradientBrush leftBrush;
            PathGradientBrush backBrush;
            PathGradientBrush topBrush;
            PathGradientBrush bottomBrush;
            ...
            public Bitmap DrawCube(Point drawOrigin)
            {
                ...
                {
                    UpdateBrush(faces[i].CubeSide);
                    switch (faces[i].CubeSide)
                    {
                        case Face.Side.Front:
                            if (fillFront)
                                g.FillPolygon(frontBrush, GetFrontFace());
                            break;
                        case Face.Side.Back:
                            if (fillBack)
                                g.FillPolygon(backBrush, GetBackFace());
                            break;
                        case Face.Side.Left:
                            if (fillLeft)
                                g.FillPolygon(leftBrush, GetLeftFace());
                            break;
                        case Face.Side.Right:
                            if (fillRight)
                                g.FillPolygon(rightBrush, GetRightFace());
                            break;
                        case Face.Side.Top:
                            if (fillTop)
                                g.FillPolygon(topBrush, GetTopFace());
                            break;
                        case Face.Side.Bottom:
                            if (fillBottom)
                                g.FillPolygon(bottomBrush, GetBottomFace());
                            break;
                        default:
                            break;
                    }
            ...
            private void UpdateBrush(Face.Side side)
            {

                PathGradientBrush brush = CreateBrush(side);
                Color[] colors;
                ...
                {
                    case Face.Side.Front:
                        brush.CenterColor = Color.FromArgb(127, 127, 0);
                        colors = new Color[4]
                        {
                            Color.FromArgb(0,255,0),  //lg
                            Color.FromArgb(0,0,0),    //ld
                            Color.FromArgb(255,0,0),      //pd
                            Color.FromArgb(255,255,0)     //pg
                        };
                        brush.SurroundColors = colors;
                        UpdateBrush(side, brush);
                        break;
                    case Face.Side.Back:
                        brush.CenterColor = Color.FromArgb(127, 127, 255);
                        colors = new Color[4]
                        {
                            Color.FromArgb(0,255,255),  //pg
                            Color.FromArgb(0,0,255),    //pd
                            Color.FromArgb(255,0,255),      //ld
                            Color.FromArgb(255,255,255)     //lg
                        };
                        brush.SurroundColors = colors;
                        UpdateBrush(side, brush);
                        break;
                    case Face.Side.Left:
                        brush.CenterColor = Color.FromArgb(0, 127, 127);
                        colors = new Color[4]
                        {
                            Color.FromArgb(0,255,0),  //pg
                            Color.FromArgb(0,255,255),    //lg
                            Color.FromArgb(0,0,255),      //ld
                            Color.FromArgb(0,0,0)     //pd
                        };
                        brush.SurroundColors = colors;
                        UpdateBrush(side, brush);
                        break;
                    case Face.Side.Right:
                        brush.CenterColor = Color.FromArgb(255, 127, 127);
                        colors = new Color[4]
                        {
                            Color.FromArgb(255,255,0),  //lg
                            Color.FromArgb(255,255,255),    //pg
                            Color.FromArgb(255,0,255),      //pd
                            Color.FromArgb(255,0,0)     //ld
                        };
                        brush.SurroundColors = colors;
                        UpdateBrush(side, brush);
                        break;
                    case Face.Side.Top:
                        brush.CenterColor = Color.FromArgb(127,255, 127);
                        colors = new Color[4]
                        {
                            Color.FromArgb(0,255,0),  //ld
                            Color.FromArgb(0,255,255),    //lg
                            Color.FromArgb(255,255,255),      //pg
                            Color.FromArgb(255,255,0)     //pd
                        };
                        brush.SurroundColors = colors;
                        UpdateBrush(side, brush);
                        break;
                    case Face.Side.Bottom:
                        brush.CenterColor = Color.FromArgb(127, 0, 127);
                        colors = new Color[4]
                        {
                            Color.FromArgb(0,0,0),  //lg
                            Color.FromArgb(0,0,255),    //ld
                            Color.FromArgb(255,0,255),      //pd
                            Color.FromArgb(255,0,0)     //pg
                        };
                        brush.SurroundColors = colors;
                        UpdateBrush(side, brush);
                        break;
            ...
            private void UpdateBrush(Face.Side side,PathGradientBrush brush)
            {
                switch (side)
                {
                    case Face.Side.Front:
            ...
            private PathGradientBrush CreateBrush(Face.Side side)
            {
                switch (side)
                {
                    case Face.Side.Front:
                        return new PathGradientBrush(GetFrontFace());
                    case Face.Side.Back:
                        return new PathGradientBrush(GetBackFace());
                    case Face.Side.Left:
                        return new PathGradientBrush(GetLeftFace());
                    case Face.Side.Right:
                        return new PathGradientBrush(GetRightFace());
                    case Face.Side.Top:
                        return new PathGradientBrush(GetTopFace());
                    case Face.Side.Bottom:
                        return new PathGradientBrush(GetBottomFace());
                    default:
                        return null;
                }
            }
